...
const reportsTable = 'reports_table';

class ReportsProvider extends ChangeNotifier {
  var api = 'connector/api/profit-loss-report';
  ...
  Future<String> getData() async {
    _syncStatus = SyncStatus.syncing;
    await getServerData(_mapData, api: api, database: database, dataKey: '');
    _syncStatus = SyncStatus.synced;
  ...
  UniqueDatabase get database => UniqueDatabase(tableName: reportsTable);
}
