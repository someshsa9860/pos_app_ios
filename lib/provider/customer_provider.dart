...
const customersTable = 'customers_contact';
...
class CustomerProvider extends ChangeNotifier {
  ...
  Future<String> getData() async {
    ...
    _syncStatus = SyncStatus.syncing;
    await getServerData(_mapData, api: api, database: database, body: body);
    _syncStatus = SyncStatus.synced;
  ...
  UniqueDatabase get database => UniqueDatabase(tableName: customersTable);
