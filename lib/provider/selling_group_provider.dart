...
const sellPGTable = 'sell_p_g_table';

class SellingGroupProvider extends ChangeNotifier {
  var api = 'connector/api/selling-price-group';

  final List<Map<String, dynamic>> _mapData = List.empty(growable: true);

  List<Map<String, dynamic>> get mapData {
    print('selling_price_groups ' + _mapData.length.toString());
    return [..._mapData];
  }
  ...
  UniqueDatabase get database => UniqueDatabase(tableName: sellPGTable);
}
