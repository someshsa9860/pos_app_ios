...
const productVarTable = 'products_var_table';

class ProductsVarProvider extends ChangeNotifier {
  var api = 'connector/api/variation';
  ...
  UniqueDatabase get database => UniqueDatabase(tableName: productVarTable);
}
