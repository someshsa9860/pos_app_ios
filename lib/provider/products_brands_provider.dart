...
const brandsTable = 'brands_table';

class ProductsBrandProvider extends ChangeNotifier {
  var api = 'connector/api/brand';
  ...
  UniqueDatabase get database => UniqueDatabase(tableName: brandsTable);
}
