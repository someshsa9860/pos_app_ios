...
const sellReturnTable = 'sell_return_table';

class SellReturnProvider extends ChangeNotifier {
  var api = 'connector/api/list-sell-return';
  ...
  UniqueDatabase get database => UniqueDatabase(tableName: sellReturnTable);
}
